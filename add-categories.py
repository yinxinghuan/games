...
CATEGORIES = {
    ...
    'before-we-get-home': 'strategy',
    'afterlight-district': 'strategy',
    'jungle-trail': 'visual',
    ...
    'water-veil': 'visual',
    'fracture-portrait': 'visual',
    'knot-runner': 'shooter',
    'last-liberty': 'strategy',
    'css-robot-reactor': 'visual',
    'ascii-aura': 'visual',
    'cylinder-tide': 'visual',
    'waterball-touch': 'visual',
    'name-relief': 'visual',
    'six-hid-it': 'puzzle',
    'carnival-spinner': 'visual',
    'matrix-sentinels': 'visual',
    'aurelia': 'visual',
    'rain-puddle': 'visual',
    'dither-reveal': 'visual',
    'morph-field': 'visual',
    'dither-field': 'visual',
    'timewell': 'visual',
    ...
    'get-off-the-train': 'action',
    'anomaly-hand': 'strategy',
    'dungeon-shift': 'strategy',
    'midnight-verdict': 'puzzle',
    'lost-time-bureau': 'strategy',
    'autumn-lost-found': 'strategy',
    'the-night-desk': 'strategy',
    'rooftop-delivery': 'action',
    'crystal-swarm': 'casual',
    'whisper-pond': 'casual',
    'sky-leap': 'action',
