...
| [Stick Hero with Canvas](https://codepen.io/HunorMarton/full/xxOMQKg) | Canvas 平台生成、按压长杆、旋转、行走和相机平移；Pen `xxOMQKg`，2026-07-27 获取 | CodePen 公共 Pen MIT；Hunor Marton Borbely | Canvas 2D、Pointer Events | 鼠标按压长度 → 触屏按住架桥，成功后无限生成下一平台，坠落才结算累计精度 | DPR、短屏平台间距、Pointer Capture、失败恢复；两尺寸通过，连续 6 桥不结算且坠落后结算 | [Skyline Span](https://yinxinghuan.github.io/skyline-span/)；机制与现有 Canvas 跑酷类别重叠，暂不拆新 Skill |
...
- Skyline Span：无尽连续技巧闭环；刷新纪录不会停局，只有失误坠落才结算累计精度。
